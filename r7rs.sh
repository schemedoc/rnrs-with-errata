...
curl --fail --silent --show-error -o r7rs-small-official.pdf \
	https://bitbucket.org/cowan/r7rs/raw/errata/rnrs/r7rs-official.pdf

curl --fail --silent --show-error -o r7rs-small-errata.md \
	https://bitbucket.org/cowan/r7rs-wg1-infra/raw/default/R7RSSmallErrata.md

curl --fail --silent --show-error -o r7rs-small-errata-corrected.pdf \
